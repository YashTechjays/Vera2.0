const DATA_MAPPING = {
    ...
    "insurance_information": {
        ...
        "health_plan": ["J19", true],
        "coordination_of_benefits": ["J20", false],
        "policy_number": ["J21", true],
        "group_information": ["J22", false],
        "group_name": ["J23", false],
        "home_plan": ["J24", false]
    },
    "benefit_coverage": {
        "benefit_year_type": ["AD16", true],
        "plan_effective_date": ["AD17", true],
        "plan_year_information": ["AD18", false],
        "coverage_type": ["AD19", true],
        "referrals_telehealth": ["AD20", true],
        "telehealth": ["AD21", false],
    ...
    "general_coverage": {
        "office_visits": {
            "cpt_1": {
                "covered": ["M28", false],
                "copay": ["P28", false],
                "coinsurance": ["S28", false],
                "prior_auth": ["V28", false]
            }
        },
        "asc_professional": {
            "cpt_1": {
    ...
    "diagnostic_labs_xray_ultrasound": {
        "diagnostic_testing": {
            "cpt_1": {
                "covered": ["M33", false],
                "copay": ["P33", false],
                "coinsurance": ["S33", false],
                "prior_auth": ["V33", false]
            },
            "cpt_2": {
                "covered": ["M34", false],
                "copay": ["P34", false],
                "coinsurance": ["S34", false],
                "prior_auth": ["V34", false]
            },
            "cpt_3": {
                "covered": ["M35", false],
                "copay": ["P35", false],
    ...
    "male_partner_coverage": {
        "semen_analysis": {
            "cpt_1": {
                "covered": ["M43", false],
                "copay": ["P43", false],
                "coinsurance": ["S43", false],
                "prior_auth": ["V43", false]
            }
        },
        "sperm_cryo": {
            "cpt_1": {
                "covered": ["M44", false],
                "copay": ["P44", false],
                "coinsurance": ["S44", false],
                "prior_auth": ["V44", false]
            }
        }
    },
    "infertility_treatment": {
        "infertility_treatment_intrauterine_insemination": {
            "cpt_1": {
                "covered": ["M48", false],
                "copay": ["P48", false],
                "coinsurance": ["S48", false],
                "prior_auth": ["V48", false],
                "cycle_limit": ["Y48", false],
                "additional_notes": ["AB48", false]
            },
            "cpt_2": {
                "covered": ["M49", false],
                "copay": ["P49", false],
                "coinsurance": ["S49", false],
                "prior_auth": ["V49", false],
                "cycle_limit": ["Y48", false],
                "additional_notes": ["AB48", false]
            },
            "cpt_3": {
                "covered": ["M50", false],
                "copay": ["P50", false],
                "coinsurance": ["S50", false],
                "prior_auth": ["V50", false],
                "cycle_limit": ["Y48", false],
                "additional_notes": ["AB48", false]
            }
        },
        "infertility_treatment_ovulation_induction": {
            "cpt_1": {
                "covered": ["M47", false],
                "copay": ["P47", false],
                "coinsurance": ["S47", false],
                "prior_auth": ["V47", false],
                "cycle_limit": ["Y47", false],
                "additional_notes": ["AB47", false]
            }
        },
        "infertility_treatment_in_vitro_fertilization": {
            "cpt_1": {
                "covered": ["M51", false],
                "copay": ["P51", false],
        ...
        "infertility_treatment_egg_cryopreservation_elective": {
            "cpt_1": {
                "covered": ["M56", false],
                "copay": ["P56", false],
                "coinsurance": ["S56", false],
                "prior_auth": ["V56", false],
                "cycle_limit": ["Y56", false],
                "additional_notes": ["AB56", false]
            }
        },
        "infertility_treatment_embryo_cryopreservation": {
            "cpt_1": {
                "covered": ["M54", false],
                "copay": ["P54", false],
                "coinsurance": ["S54", false],
                "prior_auth": ["V54", false],
                "cycle_limit": ["Y54", false],
                "additional_notes": ["AB54", false]
            },
            "cpt_2": {
                "covered": ["M55", false],
                "copay": ["P55", false],
        ...
        "infertility_treatment_frozen_embryo_transfer": {
            "cpt_1": {
                "covered": ["M58", false],
                "copay": ["P58", false],
        ...
        "infertility_treatment_egg_cryopreservation_cancer": {
            "cpt_1": {
                "covered": ["M57", false],
                "copay": ["P57", false],
                "coinsurance": ["S57", false],
                "prior_auth": ["V57", false],
                "cycle_limit": ["Y57", false],
                "additional_notes": ["AB57", false]
            }
        },
        "infertility_treatment_embryo_biopsy": {
            "cpt_1": {
                "covered": ["M59", false],
                "copay": ["P59", false],
                "coinsurance": ["S59", false],
                "prior_auth": ["V59", false],
                "cycle_limit": ["Y59", false],
                "additional_notes": ["AB59", false]
            },
            "cpt_2": {
                "covered": ["M60", false],
                "copay": ["P60", false],
    ...
    "deductibles_oop": {
        "deductible": {
            "r1": {
                "individual": ["AD29", false],
                "family": ["AH29", false]
            },
            "r2": {
                "individual": ["AD30", false],
                "family": ["AH30", false]
            },
            "r3": {
                "individual": ["AD31", false],
                "family": ["AH31", false]
            }
        },
        "out_of_pocket": {
            "r1": {
                "individual": ["AD32", false],
                "family": ["AH32", false]
            },
            "r2": {
                "individual": ["AD33", false],
                "family": ["AH33", false]
            },
            "r3": {
                "individual": ["AD34", false],
                "family": ["AH34", false]
            }
        }
    },
    "infertility_limits": {
        "lifetime_maximum": {
            ...
            "additional_notes": ["P65", false]
        }
    },
    "embryo_cryo_storage": {
        "embryo_cryo_storage": ["J62", true]
    },
    "enrollment": {
        "enrollment_required": ["AD62", false],
        "provider_name": ["AD63", false],
        "provider_phone_number": ["AD64", false],
        "center_of_excellence_required": ["AD65", false]
    },
    "authorization_department": {
        "authorization_dept_name": ["J70", false],
        "auth_dept_phone_number": ["J71", false]
    },
    "pharmacy": {
        "pharmacy_benefit_manager": ["J73", false],
        "pbm_phone_number": ["J74", false]
    },
    "infertility_specialty_pharmacy": {
        "infertility_specialty_pharmacy": ["AA67", false],
        "isp_phone_number": ["AA68", false]
    },
    "third_party": {
        "third_party": ["AD70", true]
    },
    "insurance_representative": {
        "insurance_rep_name": ["AD72", false],
        "call_reference_number": ["AD73", false],
        "web_portal_ref_number": ["AD74", false]
    },
...
function checkRequiredCellsPresent(sheet) {
  if (missingCells.length > 0) {
        ...
        const detailedMissingInfo = missingCells.map(missingCell => {
...
const VALIDATION_RULES = {
    ...
    "pbm_phone_number":   { validator: isValidPhoneNumber, displayName: "Pbm Phone number" },
    "auth_dept_phone_number": { validator: isValidPhoneNumber, displayName: "Auth Dept Phone number" },
    "portal":             { validator: isValidURL,         displayName: "Portal URL" },
    "provider_name":      { validator: isValidFlexibleName,  displayName: "Insurance provider name" },
...
function getFormattedValue(jsonKey, value) {
  ...
  // Automatic date formatting to YYYY-MM-DD string for JSON compliance
    ...
    //if not present then put N/A
    if ( jsonKey === "chart_number" && !value ) {
      return "N/A";
    }
...
function copyAndConfigureTemplate() {
  ...
  try {
    ...
    if (Object.keys(allProperties).length === 0) {
      ui.alert("Warning", "No properties found. Creating standard duplicate.", ui.ButtonSet.OK);
    }
    ...
    ui.alert("Error During Copy", `Failed to create copy: ${e.toString()}`, ui.ButtonSet.OK);
  }
}
...
function initializeProperties() {
  ...
  if (tempSheet) {
    try {
      ...
      if (propertiesJson) {
        Logger.log('STEP 2: Found properties JSON. Raw data: ' + propertiesJson); 
        
        // 2. READ & Parse the properties 
        const propertiesToSet = JSON.parse(propertiesJson);
        Logger.log('STEP 3: Successfully parsed object: ' + JSON.stringify(propertiesToSet)); 
        
        // 3. SET the properties in the *new* script's Properties Service
        PROPERTIES_SERVICE.setProperties(propertiesToSet, true); 
        Logger.log('STEP 4: Properties set successfully in new script storage.');
        ...
        ui.alert("Configuration Error", "Temporary configuration data was empty. Properties not set.", ui.ButtonSet.OK);
      }
    } catch (e) {
      Logger.log('FATAL ERROR DURING INITIALIZATION: ' + e.toString());
      ui.alert("Configuration Error", "Failed to process properties. Check the Apps Script Logs for details.", ui.ButtonSet.OK);
    }
  } else {
     //ss.toast('Already activated script properties.', 'Status', 3);
     Logger.log('STEP 1: Temporary configuration sheet was not found. Template likely already initialized.');
  }
...
function onOpen() {
  ...
  ui.createMenu('⚙️ Copy This Sheet')
      .addItem('Generate Configured Copy of this Sheet', 'copyAndConfigureTemplate')
      .addToUi();
}
