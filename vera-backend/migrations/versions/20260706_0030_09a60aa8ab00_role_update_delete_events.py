...
Revision ID: 09a60aa8ab00
Revises: 0022
Create Date: 2026-07-06 00:30:07.640654
...
them until the CHECK is widened.

Drop-and-recreate the named constraint from the CURRENT enum, exactly as
0006/0017: `DROP ... IF EXISTS` makes it a no-op on a fresh DB (where 0001
already built it with the new values) and an in-place widen on an existing
one. The value list is derived from the enum so it can never drift.
"""
